 ...
 */
angular.module('vlui')
  .directive('vlPlotGroup', ['Bookmarks', 'consts', 'vg', 'vl', 'Dataset', 'Logger', '_', 'Pills', 'Chart', function (Bookmarks, consts, vg, vl, Dataset, Logger, _, Pills, Chart) {
    return {
