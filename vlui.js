...
angular.module('vlui')
  .factory('Dataset', ['$http', '$q', 'Alerts', '_', 'vg', 'vl', 'cql', 'SampleData', 'Config', 'Logger', function($http, $q, Alerts, _, vg, vl, cql, SampleData, Config, Logger) {
    var Dataset = {};
